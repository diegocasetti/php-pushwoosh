...
use Fireless\Pushwoosh\Curl\CurlRequest;
use Fireless\Pushwoosh\Curl\ICurlRequest;
...
class CURLClient implements ICURLClient
{
     ...
     *
     * @var \Fireless\Curl\ICurlRequest
     */
    private $curlRequest;
     ...
     *
     * @return \Fireless\Curl\ICurlRequest The CURL request object currently in use.
     */
     ...
     *
     * @param \Fireless\Curl\ICurlRequest $curlRequest The CURL request object to use.
     */
