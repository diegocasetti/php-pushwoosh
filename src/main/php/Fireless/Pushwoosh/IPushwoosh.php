...
interface IPushwoosh
{
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\CreateMessageRequest $createMessageRequest the '/createMessage' request
     *        used to create the Pushwoosh message.
     *
     * @return \Fireless\Pushwoosh\Model\Response\CreateMessageResponse the resulting '/createMessage' response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\DeletMessageRequest $deleteMessageRequest the '/deleteMessage' request
     *                                                                                  used to delete a Pushwoosh
     *                                                                                  message.
     *
     * @return \Fireless\Pushwoosh\Model\Response\DeleteMessageResponse the resulting '/deleteMessage' response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\GetNearestZoneRequest $getNearestZoneRequest the '/getNearestZone' request
     *                                                                                     used to record a device
     *                                                                                     location for Georgraphical
     *                                                                                     Push Notification.
     *
     * @return \Fireless\Pushwoosh\Model\Response\GetNearestZoneResponse the resulting '/getNearestZone' response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\GetTagsRequest $getTagsRequest the '/getTags' request used to get the tags
     *                                                                       associated to a specified device.
     *
     * @return \Fireless\Pushwoosh\Model\Response\GetTagsResponse the resulting '/getTags' response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\PushStatRequest $pushStatRequest the '/pushStat' request used to register
     *                                                                         a device for Push Open events.
     *
     * @return \Fireless\Pushwoosh\Model\Response\PushStatResponse the resulting '/pushStat' response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\RegisterDeviceRequest $registerDeviceRequest the register device request
     *        used to register a device for the application.
     *
     * @return \Fireless\Pushwoosh\Model\Response\RegisterDeviceResponse the resulting register device response.
     */
     ...
     * '/setBadge' request.
     *
     * @param \Fireless\Pushwoosh\Model\Request\SetBadgeRequest $setBadgeRequest the '/setBadge' request used to set the
     *                                                                         current badge for a device to let
     *                                                                         auto-incrementing badges work properly.
     *
     * @return \Fireless\Pushwoosh\Model\Response\SetBadgeResponse the resulting '/setBadge' response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\SetTagsRequest $setTagsRequest the '/setTags' request used to set tags for
     *        a device.
     *
     * @return \Fireless\Pushwoosh\Model\Response\SetTagsResponse the resulting set tags response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Request\UnregisterDeviceRequest $unregisterDeviceRequest the '/unregisterDevice'
