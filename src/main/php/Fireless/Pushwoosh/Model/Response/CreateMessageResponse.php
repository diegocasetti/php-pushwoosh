...
class CreateMessageResponse extends AbstractResponse
{
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Response\CreateMessageResponseResponse
     */
    private $response;
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Response\CreateMessageResponse the resulting instance.
     */
     ...
     * Gets the Pushwoosh '/createMessage' response response.
     *
     * @return \Fireless\Pushwoosh\Model\Response\CreateMessageResponseResponse the Pushwoosh '/createMessage' response
     *         response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Response\CreateMessageResponseResponse $response the Pushwoosh '/createMessage'
     *        response response.
     */
