...
class GetTagsResponse extends AbstractResponse
{
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Response\GetTagsResponseResponse
     */
    private $response;
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Response\GetTagsResponse the resulting instance.
     */
     ...
     * Gets the Pushwoosh '/getTags' response response.
     *
     * @return \Fireless\Pushwoosh\Model\Response\GetTagsResponseResponse the Pushwoosh '/createMessage' response
     *         response.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Response\GetTagsResponseResponse $response the Pushwoosh '/createMessage'
     *        response response.
     */
