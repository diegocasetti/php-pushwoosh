...
use Fireless\Pushwoosh\Model\Condition\ICondition;
...
class Notification
{
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\ADM
     */
    private $aDM;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\Android
     */
    private $android;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\BlackBerry
     */
    private $blackBerry;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Condition\ICondition[]
     */
    private $conditions;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\IOS
     */
    private $iOS;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\Mac
     */
    private $mac;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\MinimizeLink
     */
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\Platform[]
     */
    private $platforms;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\Safari
     */
    private $safari;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\WNS
     */
    private $wNS;
     ...
     *
     * @var \Fireless\Pushwoosh\Model\Notification\WP
     */
    private $wP;
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification the new created notification.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Condition\ICondition $condition the new condition to add.
     */
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\Platform $platform the new platform to add.
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\ADM the object which contains specific Pushwoosh notification
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Android
     */
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\BlackBerry
     */
     ...
     * You cannot use 'filter' and 'conditions' parameters together.
     *
     * @return \Fireless\Pushwoosh\Model\Condition\ICondition the array of tag conditions.
     */
     ...
     * Service).
     *
     * @return \Fireless\Pushwoosh\Model\Notification\IOS the object which contains specific Pushwoosh notification
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Mac the object which contains specific Pushwoosh notification
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\MinimizeLink the parameter used to indicate if the link must be
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Platform[] the platforms where to send push notifications.
     */
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Safari the object which contains specific Pushwoosh notification
     ...
     * Service).
     *
     * @return \Fireless\Pushwoosh\Model\Notification\WNS the object which contains specific Pushwoosh notification
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Notification\WP the object which contains specific Pushwoosh notification
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\ADM $aDM the object which contains specific Pushwoosh notification
     *        informations for ADM (Amazon Device Messaging).
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\Android $android the object which contains specific Pushwoosh
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\BlackBerry $blackBerry the object which contains specific Pushwoosh
     ...
     * You cannot use 'filter' and 'conditions' parameters together.
     *
     * @param \Fireless\Pushwoosh\Model\Condition\ICondition $conditions the array of tag conditions.
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     * Service).
     *
     * @param \Fireless\Pushwoosh\Model\Notification\IOS $iOS the object which contains specific Pushwoosh notification
     *        informations for IOS (Apple Push Notification Service).
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\Mac $mac the object which contains specific Pushwoosh notification
     *        informations for Mac OS X.
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\MinimizeLink the parameter used to indicate if the link must be
     *         minimized and how to minimize it.
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     * Sets the platforms to which ones to send messages.
     *
     * @param \Fireless\Pushwoosh\Model\Notification\Platform[] $platforms the platforms where to send the push
     *                                                                   notifications.
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\Safari $safari the object which contains specific Pushwoosh
     ...
     * Service).
     *
     * @param \Fireless\Pushwoosh\Model\Notification\WNS $wNS the object which contains specific Pushwoosh notification
     *        informations for WNS (Windows Notification Service).
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
     ...
     *
     * @param \Fireless\Pushwoosh\Model\Notification\WP $wP the object which contains specific Pushwoosh notification
     *        informations for WP (Windows Phone).
     *
     * @return \Fireless\Pushwoosh\Model\Notification\Notification this instance.
     */
