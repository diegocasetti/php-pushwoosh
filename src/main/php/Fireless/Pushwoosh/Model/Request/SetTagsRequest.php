...
class SetTagsRequest
{
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Request\SetTagsRequest the new created instance.
     */
     ...
     *
     * @throws \Fireless\Pushwoosh\Exception\PushwooshException if a tag having the specified name has already been added.
     */
     ...
     *
     * @return \Fireless\Pushwoosh\Model\Request\SetTagsRequest this instance.
     */
